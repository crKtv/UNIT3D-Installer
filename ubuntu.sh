...
add_pkgs() {
    ...
    apt-get -qq install curl php-pear php8.5-common php8.5-cli php8.5-fpm php8.5-{redis,bcmath,curl,dev,gd,igbinary,intl,mbstring,mysql,opcache,readline,xml,zip} > /dev/null
